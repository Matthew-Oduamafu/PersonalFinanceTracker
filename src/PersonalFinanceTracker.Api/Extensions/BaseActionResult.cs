...
public static class BaseActionResult
{
    public static IResult ToActionResult<T>(this IGenericApiResponse<T> response)
    {
        ...
        return response.Code switch
        {
            ...
            StatusCodes.Status202Accepted => Results.Content(json, "application/json",
                statusCode: StatusCodes.Status202Accepted),

            StatusCodes.Status201Created => Results.Content(json, "application/json",
            ...
            StatusCodes.Status401Unauthorized => Results.Content(json, "application/json",
            ...
            StatusCodes.Status424FailedDependency => Results.Content(json, "application/json",
                statusCode: StatusCodes.Status424FailedDependency),

            StatusCodes.Status500InternalServerError => Results.Content(json, "application/json",
